...
Journey is a lightweight modlist designed to give an enhanced graphical presentation that keeps the spirit of Skyrim's aesthetic and provide a cohesive lightweight gameplay overhaul with an optional survival component using Survival Mode. Journey's purpose is to provide a base graphical and gameplay overhaul to play an enhanced Skyrim experience with a few carefully selected additional quests, and new lands included. Journey should look beautiful, but run well even on lower end systems.
